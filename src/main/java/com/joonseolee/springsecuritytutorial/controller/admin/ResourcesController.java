package com.joonseolee.springsecuritytutorial.controller.admin;

import com.joonseolee.springsecuritytutorial.domain.Resources;
import com.joonseolee.springsecuritytutorial.domain.ResourcesDto;
import com.joonseolee.springsecuritytutorial.domain.ResourcesMapper;
import com.joonseolee.springsecuritytutorial.domain.Role;
import com.joonseolee.springsecuritytutorial.repository.RoleRepository;
import com.joonseolee.springsecuritytutorial.security.metadatasource.UrlFilterInvocationSecurityMetadataSource;
import com.joonseolee.springsecuritytutorial.service.ResourcesService;
import com.joonseolee.springsecuritytutorial.service.RoleService;
...
//    private MethodSecurityService methodSecurityService;
    ...
    public String createResources(ResourcesDto resourcesDto) throws Exception {
        ...
        roles.add(role);
        Resources resources = resourcesMapper.toResources(resourcesDto);
...
//            methodSecurityService.addMethodSecured(resourcesDto.getResourceName(),resourcesDto.getRoleName());
    ...
    public String getResources(@PathVariable String id, Model model) throws Exception {
        ...
        ResourcesDto resourcesDto = resourcesMapper.toResourcesDto(resources);
